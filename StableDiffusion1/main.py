...
#     caption_dir = "data/cub_text_embeddings/text"

#     # Dataset and Dataloader
#     dataset = CUBDataset(image_root=image_dir, caption_root=caption_dir)
...
#         inputs = tokenizer(captions, padding="max_length", truncation=True, max_length=77, return_tensors="pt").input_ids.to(device)

#         print("Batch of images:", images.shape)
#         print("Tokenized captions:", inputs.shape)
#         break  # Remove this once you begin training

#     print("Data loading successful! Ready to train.")
